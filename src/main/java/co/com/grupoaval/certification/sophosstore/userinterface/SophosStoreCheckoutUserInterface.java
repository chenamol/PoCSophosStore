...
public class SophosStoreCheckoutUserInterface {
	...
	public static final Target TXT_COMPANIA = Target.the("Campo para ingresar la compa�ia del usuario")
	...
	public static final Target TXT_TELEFONO = Target.the("Campo para ingresar el tel�fono del usuario")
	...
	public static final Target TXT_CODIGOPOSTAL = Target.the("Campo para ingresar el c�digo postal del usuario")
			.locatedBy("//input[@ng-reflect-name='zip']");

	public static final Target TXT_DIRECCION = Target.the("Campo para ingresar la direcci�n del usuario")
			.locatedBy("//input[@ng-reflect-name='address']");

	public static final Target BTN_CONTINUAR = Target.the("bot�n para continuar con la compra")
